                            ...
                            <table class="table text-nowrap">
                                ...
                                <tr>
                                    <td>
                                        <div class="media-left media-middle">
                                            <a href="#"><img
                                                        src="{{url('public/admin/assets/images/placeholder.jpg')}}"
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="media-left">
                                            <div class=""><a href="#" class="text-default text-semibold">Spotify
                                                    ads</a></div>
                                            <div class="text-muted text-size-small">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="media-left">
                                            <div class=""><a href="#" class="text-default text-semibold">Twitter
                                                    ads</a></div>
                                            <div class="text-muted text-size-small">
                                                <span class="status-mark border-grey-400 position-left"></span>
                                                04:00 - 05:00
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="media-left">
                                            <div class=""><a href="#" class="text-default text-semibold">Amazon
                                                    ads</a></div>
                                            <div class="text-muted text-size-small">
                                                <span class="status-mark border-danger position-left"></span>
                                                18:00 - 19:00
                                        ...
                                        <ul class="icons-list">
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <li class="divider"></li>
                                                    <li><a href="#"><i class="icon-checkmark3 text-success"></i>
                                                            Resolve issue</a></li>
                                                    <li><a href="#"><i class="icon-cross2 text-danger"></i> Close
                                                            issue</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="icons-list">
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <li class="divider"></li>
                                                    <li><a href="#"><i class="icon-plus3 text-blue"></i> Unresolve
                                                            issue</a></li>
                                                    <li><a href="#"><i class="icon-cross2 text-danger"></i> Close
                                                            issue</a></li>
                                                </ul>
                                    ...
                                    <ul class="media-list content-group">
                                        <li class="media stack-media-on-mobile">
                                            <div class="media-left">
                                                <div class="thumb">
                                                    <a href="#">
                                                        <img src="{{url('public/admin/assets/images/placeholder.jpg')}}"
